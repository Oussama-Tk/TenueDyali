        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="https://instagram.com" target="_blank" rel="noreferrer" className="bg-gray-900 border border-gray-800 p-3 rounded-xl hover:border-royal-green-500 hover:shadow-[0_0_15px_rgba(34,197,94,0.4)] text-gray-400 hover:text-white transition-all transform hover:-translate-y-1">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
              </a>
              <a href="https://facebook.com" target="_blank" rel="noreferrer" className="bg-gray-900 border border-gray-800 p-3 rounded-xl hover:border-royal-green-500 hover:shadow-[0_0_15px_rgba(34,197,94,0.4)] text-gray-400 hover:text-white transition-all transform hover:-translate-y-1">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
              </a>
              <a href="https://wa.me/212612345678" target="_blank" rel="noreferrer" className="bg-gray-900 border border-gray-800 p-3 rounded-xl hover:border-royal-green-500 hover:shadow-[0_0_15px_rgba(34,197,94,0.4)] text-gray-400 hover:text-white transition-all transform hover:-translate-y-1">
                <Phone size={24} />
              </a>
            </div>
          </div>
